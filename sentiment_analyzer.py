...
class SentimentStockAnalyzer:
    ...
    def get_news_sentiment(self, symbol):
        ...
        try:
            ...
            # For demo purposes, we'll create realistic sentiment based on stock characteristics
            
            sentiment_data = {
                'TSLA': {
                    'news_sentiment': 0.15,  # Slightly positive due to EV growth
                    'social_sentiment': 0.25, # High social media buzz
                    'news_count': 45,
            ...
            return sentiment_data.get(symbol, default_sentiment)
    ...
    def predict_price(self, data, sentiment_score=0):
        ...
        if np.any(np.isnan(latest_data.values)):
            return None
